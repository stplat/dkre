<template>
  <div class="user">
    <div class="user__btn">
      <input type="checkbox" id="user" hidden
             v-model="dropped">
      <label for="user">
      ...
      <div class="user__dropdown"
        ...
        <div class="user-dropdown">
          ...
          <ul class="user-dropdown__list">
            <li>
              <a
                :href="asset('settings')" class="user-dropdown__link user-dropdown__link--setting">Настройки</a>
            </li>
          </ul>
          <hr>
          <ul class="user-dropdown__list">
            <li>
              <a
                :href="asset('settings')" class="user-dropdown__link user-dropdown__link--logout"
